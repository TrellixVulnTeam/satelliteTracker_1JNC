(function (window, document, undefined) {
	...
	d3.csv('static/d3/sun.csv', function (d) {
        return {
			lat: +d.lat,
			lon: +d.lon,
        };
	...
	d3.csv('static/d3/groundData.csv', function (d) {
        return {
			name: d.name,
			latidute: +d.lat,
			longitude: +d.lon,
	...
	d3.csv('static/d3/orbitLength.csv', function (d) {
        return {
			l: +d.len
        };
    }, function (data) {
	...
	d3.csv('static/d3/satelliteData.csv', function (d) {
        return {
			name: d.name,
			latitude: +d.latitude,
